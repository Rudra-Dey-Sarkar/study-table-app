...
async function LoginUser(router: AppRouterInstance) {
...
function Login() {
  ...
  return (
    <form 
    onSubmit={handleSubmit((data) => LoginUser(router))}
    className='grid border-2 border-gray-300 p-2'>
      ...
      <button
        type='submit'
        className='bg-gray-300 p-2 mt-2 font-semibold hover:cursor-pointer'>Login</button>
    </form>
  );
}
