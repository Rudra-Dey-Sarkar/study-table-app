...
async function RegisterUser(router: AppRouterInstance) {
...
function Register() {
    ...
    return (
        <form
            onSubmit={handleSubmit((data) => RegisterUser(router))}
            ...
            <button
                type='submit'
                className='bg-gray-300 p-2 mt-2 font-semibold hover:cursor-pointer'>Register</button>
        </form>
    );
}
