  ...
  return (
    <div className='bg-[#1B1B1B] grid sm:flex justify-between gap-y-10 sm:gap-y-0 px-10 py-5 mt-25'>
      ...
      <div className='text-[#EDEDED]'>
        ...
        <p className='hover:cursor-pointer hover:underline'>How we plan learning session ?</p>
        <p className='hover:cursor-pointer hover:underline'>How we plan assessment session ?</p>
        <p className='hover:cursor-pointer hover:underline'>How we manage student life ?</p>
        <p className='hover:cursor-pointer hover:underline'>The effective student</p>
      </div>
      </div>
    </div>
  )
